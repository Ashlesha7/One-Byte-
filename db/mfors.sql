...
ALTER TABLE reservation ADD COLUMN id INT NOT NULL;
ALTER TABLE reservation ADD INDEX idx_user_id (user_id);
ALTER TABLE reservation ADD COLUMN table_id INT DEFAULT NULL;
...
DO
  ...
  WHERE status = 'pending' AND date_res < NOW() - INTERVAL 1 HOUR;
//
DELIMITER ;
